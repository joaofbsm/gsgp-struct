...
"""Combines GP relevant output data in a single file"""
...
def main(args):
    dir_path = "/Users/joaofbsm/Documents/UFMG/2017-2/POC1/implementation/results/gp/"
    ...
    for file in sorted(os.listdir(dir_path)):
        if file.endswith(".txt") and not file == "results.txt":
            ...
            with open(dir_path + file, 'r') as f:
                ...
                if not lines:
                    continue 
            bestTr = lines[-4].split(" ")[-1].split('/')[0]
            bestTs = lines[-4].split(" ")[-1].split('/')[1]
