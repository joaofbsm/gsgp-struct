...
public class GSGPIndividual extends Individual{
    ...
    public GSGPIndividual(BigInteger numNodes,  Fitness fitnessFunction, GSGPIndividual T1, GSGPIndividual T2, Double crossoverConst, Integer mutationT1, double mutationStep) {
        super(null, fitnessFunction);

        fitnessFunction.setNumNodes(numNodes);

        reprCoef = new HashMap<>();
        this.propagateCoefficients(T1, T2, crossoverConst, mutationT1, mutationStep);
    }
     ...
     * @param parent2
     */
    public void propagateCoefficients(GSGPIndividual parent1, GSGPIndividual parent2, Double crossoverConst, Integer mutationT1, double mutationStep) {
